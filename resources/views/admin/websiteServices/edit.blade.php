...
@section('page-title', 'Edit Website Service')
...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update dynamic frontend service section content
        </p>
    </div>
</div>
...
<form method="POST" action="{{ route('admin.website-services.update', $websiteService->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="badge_text"
                               id="badge_text"
                               value="{{ old('badge_text', $websiteService->badge_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $websiteService->title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="highlight_title"
                               value="{{ old('highlight_title', $websiteService->highlight_title) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $websiteService->description) }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    @if($websiteService->getFirstMedia('service_image'))
                        <div class="mt-3">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               name="sort_order"
                               id="sort_order"
                               value="{{ old('sort_order', $websiteService->sort_order) }}"
                               placeholder="0"
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('is_featured', $websiteService->is_featured) ? 'checked' : '' }}">
                        <input type="checkbox"
                               name="is_featured"
                               value="1"
                               class="role-checkbox"
                               {{ old('is_featured', $websiteService->is_featured) ? 'checked' : '' }}>
                ...
                <div class="field-group">
                    ...
                    <label class="role-checkbox-item {{ old('status', $websiteService->status) ? 'checked' : '' }}">
                        <input type="checkbox"
                               name="status"
                               value="1"
                               class="role-checkbox"
                               {{ old('status', $websiteService->status) ? 'checked' : '' }}>
                ...
                @if($websiteService->getFirstMedia('service_image'))
                    <form method="POST"
                          action="{{ route('admin.website-services.removeImage', $websiteService->id) }}"
                          class="mt-3"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="point_one_title"
                               value="{{ old('point_one_title', $websiteService->point_one_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="point_one_text"
                               id="point_one_text"
                               value="{{ old('point_one_text', $websiteService->point_one_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="point_two_title"
                               value="{{ old('point_two_title', $websiteService->point_two_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="point_two_text"
                               id="point_two_text"
                               value="{{ old('point_two_text', $websiteService->point_two_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('point_three_title', $websiteService->point_three_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="point_three_text"
                               value="{{ old('point_three_text', $websiteService->point_three_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="button_one_text"
                               value="{{ old('button_one_text', $websiteService->button_one_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="button_one_link"
                               value="{{ old('button_one_link', $websiteService->button_one_link) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="button_two_text"
                               value="{{ old('button_two_text', $websiteService->button_two_text) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               id="button_two_link"
                               value="{{ old('button_two_link', $websiteService->button_two_link) }}"
                               placeholder="contact"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('floating_one_title', $websiteService->floating_one_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('floating_one_subtitle', $websiteService->floating_one_subtitle) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('floating_two_title', $websiteService->floating_two_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('floating_two_subtitle', $websiteService->floating_two_subtitle) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="stats_title"
                               id="stats_title"
                               value="{{ old('stats_title', $websiteService->stats_title) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="stats_subtitle"
                               id="stats_subtitle"
                               value="{{ old('stats_subtitle', $websiteService->stats_subtitle) }}"
